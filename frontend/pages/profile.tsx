...
function Profile() {
  ...
  const initiateMFASetup = useCallback(async () => {
    try {
      ...
      // }
      const response = await api.post("/api/auth/mfa/setup/", payload, {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto px-4 py-8 mt-16">
        {profile ? (
          <motion.div className="bg-white p-6 rounded shadow" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <p>
              <strong>MFA Enabled:</strong> {profile.mfa_enabled ? "Yes" : "No"}
            </p>
                ...
                <div className="flex space-x-4">
                  ...
                  {mfaSetupData && (
                    <div className="mt-6 border p-4 rounded bg-gray-50">
                      ...
                      <p className="mb-2">
                        Please scan the QR code with your authenticator app. The QR code will disappear in {countdown}{" "}
                        seconds.
                      </p>
                      <div className="mb-2">
